 ...
 * 
 * @param type - тип теста выбраной пиццы
 ...
 */
export const calcTotalPizzaPrice =  (type: PizzaType ,size: PizzaSize , items: ProductItem[], ingredients: Ingredient[], selectedIngredients: Set<number> = new Set<number>(),) => {
    const pizzaPrice = 
